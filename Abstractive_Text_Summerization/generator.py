...
class Generator(object):
    ...
    def _add_placeholders(self):
        ...
        if (hps.mode == "decode" or hps.mode == "predict") and hps.coverage:
    ...
    def _add_decoder(self, inputs):
        ...
        p_gens, state_list, coverage = attention_decoder(inputs,
                                                         ...
                                                         self.dec_cell,
                                                         initial_state_attention=(hps.mode == "decode" or hps.mode == "predict"),
    ...
    def _add_seq2seq(self):
        ...
        if hps.mode == "decode" or hps.mode == "predict":

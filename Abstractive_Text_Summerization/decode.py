...
class BeamSearchDecoder(object):
    ...
    def __init__(self, model, batcher, vocab):
        ...
        if FLAGS.mode !="predict":
            ...
            if FLAGS.single_pass:
                ...
                self._rouge_article_dir = os.path.join(self._decode_dir, "article")
    ...
    def decode(self):
        ...
        while True:
            ...
            if FLAGS.single_pass:
                self.write_for_rouge(original_abstract_sents, decoded_words, original_article,
